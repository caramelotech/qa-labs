...
O principal objetivo de quem testa e a **antecipacao de problemas** que poderiam ser identificados apenas quando o produto ja estivesse nas maos das pessoas usuarias.
...
O dia a dia de quem testa e permeado por interacoes com o time, seja para entender o produto, comunicar atividades, discutir inconsistencias ou compartilhar conhecimento.

### Algumas dicas

- Tenha precisao e assertividade ao comunicar riscos e inconsistencias
...
- Na ideacao, revisando a viabilidade do produto
...
Riscos representam a possibilidade de beneficio ou prejuizo. Em testes, olhamos para a possibilidade de prejuizo. Uma atividade importante de QA e olhar para uma aplicacao e tentar identificar como ela pode dar errado para mitigar esses riscos com testes.

## A interacao com o time

Sua interacao com o time deve ser colaborativa, buscando ajuda-los a aplicar testes e mostrando os impactos de nao testar.

## Ajudar o time a conhecer diversas abordagens de teste

Por muitos anos, a realidade foi a segregacao de papeis entre construcao e testes. Isso maximizou o que chamamos de terceirizacao da qualidade.
...
Imagine um software em camadas. A divisao mais basica e frontend e backend, mas tambem existem camadas intermediarias. E necessario testar em cada uma delas.
...
A identificacao do que testar pode ocorrer a partir de duas abordagens: **empirica** ou **sistematica**.
